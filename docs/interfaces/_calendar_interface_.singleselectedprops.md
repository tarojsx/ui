...
• **currentDate**? : _Calendar.DateArg_
...
_Inherited from [PropsBase](\_calendar_interface_.propsbase.md).[onClickNextMonth](_calendar_interface_.propsbase.md#optional-onclicknextmonth)\_
