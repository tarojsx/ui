...
export const Button: React.FC<ButtonProps> = (props) => {
  const { className, style, type, size, circle, full, transparent, fab, children, clickThrottle, onClick, ...rest } =
    props;
  ...
  return (
    ...
    >
      ...
      {!props.disabled && !props.loading && <_Button className="at-button__wxbutton" onClick={handleClick} {...rest} />}
    </View>
  );
};
